...
const enTranslations = {
    ...
    landing: {
        ...
        hero: {
            ...
            subtitle: "Create, manage, and track invoices with automatic VAT calculations and real-time tax regulation updates from Croatian tax authorities.",
        ...
        testimonials: {
            ...
            user1: {
                ...
                content: "Racunko has revolutionized our invoicing process. The automatic tax calculations save us hours every week."
            },
            user2: {
                name: "Ana Novak",
                role: "Freelance Designer",
                content: "Finally, an invoicing solution that understands Croatian tax regulations. Highly recommended!"
            }
        },
        cta: {
            title: "Ready to Transform Your Invoicing?",
            subtitle: "Join thousands of businesses already using Racunko to streamline their operations.",
